...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PORESKASTOPA_LIST actions', async () => {
    ...
    it('dispatches FETCH_PORESKASTOPA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PORESKASTOPA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PORESKASTOPA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PORESKASTOPA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PORESKASTOPA actions', async () => {
      const expectedActions = [
        {
