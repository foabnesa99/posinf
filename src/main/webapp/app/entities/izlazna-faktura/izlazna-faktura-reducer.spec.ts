...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IZLAZNAFAKTURA_LIST actions', async () => {
    ...
    it('dispatches FETCH_IZLAZNAFAKTURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IZLAZNAFAKTURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IZLAZNAFAKTURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IZLAZNAFAKTURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IZLAZNAFAKTURA actions', async () => {
      const expectedActions = [
        {
