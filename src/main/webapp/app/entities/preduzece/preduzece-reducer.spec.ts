...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './preduzece.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PREDUZECE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PREDUZECE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PREDUZECE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PREDUZECE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PREDUZECE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PREDUZECE actions', async () => {
      const expectedActions = [
        {
