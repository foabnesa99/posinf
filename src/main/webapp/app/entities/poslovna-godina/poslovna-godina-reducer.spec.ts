...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSLOVNAGODINA_LIST actions', async () => {
    ...
    it('dispatches FETCH_POSLOVNAGODINA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSLOVNAGODINA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSLOVNAGODINA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSLOVNAGODINA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSLOVNAGODINA actions', async () => {
      const expectedActions = [
        {
