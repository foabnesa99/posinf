...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './kupac.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KUPAC_LIST actions', async () => {
    ...
    it('dispatches FETCH_KUPAC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KUPAC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KUPAC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KUPAC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KUPAC actions', async () => {
      const expectedActions = [
        {
