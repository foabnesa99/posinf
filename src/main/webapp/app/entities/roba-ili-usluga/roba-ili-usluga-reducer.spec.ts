...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROBAILIUSLUGA_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROBAILIUSLUGA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROBAILIUSLUGA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROBAILIUSLUGA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROBAILIUSLUGA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROBAILIUSLUGA actions', async () => {
      const expectedActions = [
        {
