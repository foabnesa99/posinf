...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STAVKAFAKTURE_LIST actions', async () => {
    ...
    it('dispatches FETCH_STAVKAFAKTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STAVKAFAKTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STAVKAFAKTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STAVKAFAKTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STAVKAFAKTURE actions', async () => {
      const expectedActions = [
        {
