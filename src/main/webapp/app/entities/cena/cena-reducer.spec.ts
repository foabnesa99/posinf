...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cena.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CENA_LIST actions', async () => {
    ...
    it('dispatches FETCH_CENA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CENA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CENA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CENA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CENA actions', async () => {
      const expectedActions = [
        {
