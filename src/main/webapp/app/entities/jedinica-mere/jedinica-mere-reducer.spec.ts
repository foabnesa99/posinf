...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JEDINICAMERE_LIST actions', async () => {
    ...
    it('dispatches FETCH_JEDINICAMERE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JEDINICAMERE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JEDINICAMERE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JEDINICAMERE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JEDINICAMERE actions', async () => {
      const expectedActions = [
        {
