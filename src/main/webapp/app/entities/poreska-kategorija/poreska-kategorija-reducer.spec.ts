...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './poreska-kategorija.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PORESKAKATEGORIJA_LIST actions', async () => {
    ...
    it('dispatches FETCH_PORESKAKATEGORIJA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PORESKAKATEGORIJA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PORESKAKATEGORIJA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PORESKAKATEGORIJA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PORESKAKATEGORIJA actions', async () => {
      const expectedActions = [
        {
